<div class="d-none d-lg-block d-flex justify-content-end">
    <div class="mt-3 mb-1 text-right px-2 pb-5 fixed-bottom d-flex justify-content-end"><a href="{{url()->previous()}}" class="btn btn-warning"
            style="width:53px; "><i class="fas fa-arrow-circle-left"></i></a>
    </div>
    <div class="mt-3 mb-1 text-right px-2 pb-1 fixed-bottom d-flex justify-content-end"><a href="{{route('home')}}"
            class="btn btn-info" style="width:53px"><i class="fas fa-home"></i></a>
    </div>
</div>
<div class="dropdown mt-4 pt-5 pr-2 text-right fixed-top" style="z-index: 1;">
